              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value={0} disabled className="bg-gray-500 text-gray-400">
                        Select your rating
                      </option>
                      <option value={5} className="bg-gray-500 text-white">
                        ⭐⭐⭐⭐⭐ (5 stars)
                      </option>
                      <option value={4} className="bg-gray-500 text-white">
                        ⭐⭐⭐⭐ (4 stars)
                      </option>
                      <option value={3} className="bg-gray-500 text-white">
                        ⭐⭐⭐ (3 stars)
                      </option>
                      <option value={2} className="bg-gray-500 text-white">
                        ⭐⭐ (2 stars)
                      </option>
