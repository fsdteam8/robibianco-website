        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative inline-block mb-8 sm:mb-12 lg:mb-16 ">
            ...
            <div className="relative">
              <div
                ref={wheelRef}
                className="w-72 h-72 font-body md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] xl:w-[36rem] xl:h-[36rem] rounded-full relative overflow-hidden border-8 lg:border-12 border-gray-300 transition-transform  shadow-2xl"
                // onClick={handleSpin}
              >
                <svg
                  width="100%"
