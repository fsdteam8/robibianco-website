      ...
      {showSkipButton && (
        <div className="absolute top-6 right-6 z-10">
          <Button
            ...
            className="bg-[#f97316] font-heading hover:bg-[#ea580c] text-white px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105"
          >
            Skip to Spin & Win
          </Button>
        </div>
        ...
        {slides.map((_, index) => (
          <div
            ...
            className={`w-2 h-2 rounded-full transition-colors duration-300 ${
              index === currentSlide ? "bg-white font-heading" : "bg-white/50 font-popp"
            }`}
          />
        ))}
      </div>
