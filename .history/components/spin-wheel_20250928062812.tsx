...
export default function SpinWheel({
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      <div className="bg-[#48a256] text-white text-center py-8 sm:py-12 lg:py-16 relative">
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold px-4 mb-2">
          Spin & Win
        </h1>
      ...
      <div className="px-4 py-8 sm:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 mb-8 sm:mb-12 lg:mb-16 leading-relaxed px-4 font-medium">
            Tap the wheel to spin and reveal your prize. Every spin gives you a
            chance to win exciting rewards!
          </p>

          <div className="relative inline-block mb-8 sm:mb-12 lg:mb-16 rotate-180">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2 sm:-translate-y-3 lg:-translate-y-4 z-30">
            ...
            <div className="relative">
              <div
                ref={wheelRef}
                className="w-72 h-72 sm:w-96 sm:h-96 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] xl:w-[36rem] xl:h-[36rem] rounded-full relative overflow-hidden border-8 lg:border-12 border-gray-300 cursor-pointer transition-transform hover:scale-105 shadow-2xl"
                onClick={handleSpin}
              >
                <svg
                  width="100%"
          ...
          <button
            ...
            className={`w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto font-bold py-4 sm:py-5 lg:py-6 px-8 sm:px-10 lg:px-12 rounded-2xl text-lg sm:text-xl lg:text-2xl transition-all duration-200 ${
              spinWheelMutation.isPending ||
              hasSpun ||
              wheelSegments.length === 0
