      ...
      <div className="relative z-10">
        ...
        <div className="relative z-20 px-4 py-8">
          <div className="max-w-2xl mx-auto bg-black/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 text-white">
            <h2 className="text-2xl md:text-5xl font-bold mb-8 text-center font-heading">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value={5} className="bg-black/20 text-white">
                        ⭐⭐⭐⭐⭐ (5 stars)
                      </option>
                      <option value={4} className="bg-black/20 text-white">
                        ⭐⭐⭐⭐ (4 stars)
                      </option>
                      <option value={3} className="bg-black/20 text-white">
                        ⭐⭐⭐ (3 stars)
                      </option>
                      <option value={2} className="bg-black/20 text-white">
                        ⭐⭐ (2 stars)
                      </option>
                      <option value={1} className="bg-black/20 text-white">
                        ⭐ (1 star)
                      </option>
                    </select>
