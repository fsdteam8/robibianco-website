...
import { useSpinWheel } from "@/hooks/use-api"
...
export default function SpinWheel({ reviewId, onSpinComplete }: SpinWheelProps) {
  ...
  const handleSpin = async () => {
    if (spinWheelMutation.isPending || hasSpun) return
