...
export default function SpinWheel({ onSpinComplete }: SpinWheelProps) {
  ...
  // Mock rewards data
  const mockRewards = [
    { _id: '1', rewardName: '10% Discount', isTryAgain: true },
    { _id: '2', rewardName: '20% Discount', isTryAgain: true },
    { _id: '3', rewardName: '30% Discount', isTryAgain: true },
    { _id: '4', rewardName: 'Try again', isTryAgain: false },
    { _id: '5', rewardName: '40% Discount', isTryAgain: true },
    { _id: '6', rewardName: 'Try again', isTryAgain: false },
    { _id: '7', rewardName: '50% Discount', isTryAgain: true },
    { _id: '8', rewardName: 'Try again', isTryAgain: false },
  ];
          ...
          <div className="relative mb-8">
            ...
            <div className="relative">
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-12 z-10">
                ...
                >
                  <path
                    d="M16 48L0 24L16 0L32 24L16 48Z"
                    fill="#dc2626"
                  />
                </svg>
              </div>
