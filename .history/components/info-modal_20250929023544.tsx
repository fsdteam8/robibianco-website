          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-start gap-3">
                ...
                <p>
                  Tap the orange &#34;Tap to Spin" button to start spinning the
                  wheel
                </p>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <ul className="space-y-2 text-sm text-blue-800">
                ...
                <li>
                  • The app automatically returns to home after 30 seconds on
                  result screens
                </li>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <p className="text-sm text-gray-600">
                ...
                Spin & Win game, please contact our support team. We're here to
                help you make the most of your spinning experience!
              </p>
            </div>
          </div>
        </div>
