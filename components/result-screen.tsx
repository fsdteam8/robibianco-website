...
export default function ResultScreen({ result, onBackToHome }: ResultScreenProps) {
  const isWinner = result.discount && result.discount > 0
  ...
  return (
    <div className="min-h-screen bg-[#48a256] relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-16 text-center text-white">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-12 text-[#f97316]">You Win: {result.discount}% discount</h2>
        ...
        <div className="max-w-md mx-auto bg-[#cdda55] text-black rounded-2xl p-8 mb-12">
          ...
          <div className="space-y-2">
            <p className="font-bold text-lg">Prize Code: {result.code}</p>
            <p className="text-sm">Show this to your server to claim your prize</p>
          </div>
        </div>
