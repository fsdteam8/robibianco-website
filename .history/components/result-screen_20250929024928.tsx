  ...
  return (
    <div className="min-h-screen bg-[#48a256] relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-8 sm:py-12 lg:py-16 text-center text-white">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 lg:mb-6 text-balance">
          Congratulations!
        </h1>

        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-8 sm:mb-12 lg:mb-16 text-[#f97316] text-balance px-4 [-webkit-text-stroke:1px_black]">
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      <div className="bg-[#48a256] text-white text-center py-6 sm:py-8 lg:py-12 relative">
        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold px-4">
          Spin & Win
        </h1>
